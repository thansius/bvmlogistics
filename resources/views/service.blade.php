        ...
        <div class="container">
            ...
            <div class="row pb-3">
                <div class="col-lg-6 col-md-6 mb-5">
                    ...
                    <ul>
                        <li>Competitive rates TO and FROM all overseas destination </li>
                        <li>Planing the best possible shipment route with emphasis on speed and economy</li>
                        <li>Cargo booking and arrangements</li>
                        <li>Local collections and services at all offices</li>
                        <li>Preparation of export documentation</li>
                        <li>Pre-advice communication to our overseas breakbulk agents</li>
                        <li>Air cargo advisory service </li>
                    </ul>
                ...
                <div class="col-lg-6 col-md-6 mb-5">
                    ...
                    <ul>
                        <li>LCL/FCL Service TO and FROM the USA, Europe, and Asia</li>
                        <li>Consolidation services TO and FROM the USA, Europe and Asia</li>
                        <li>Cargo acceptance to various worldwide destinations utilizing dependable and established shipping lines</li>
                        <li>Port to port, port to door, and door to door service</li>
                        <li>Brokerage and trucking services</li>
                        <li>Major supporter of top shipping lines, ensuring preferential space allocation on specified schedules and competitive rates via special service contracts</li>
                        <li>Efficient handling of wide-range and major moving commodities</li>
                        <li>Goods insured through reputable brokers in Europe, USA and the rest of the world </li>
                    </ul>
                    {{-- <a class="border-bottom text-decoration-none" href="">Read More</a> --}}
                </div>
            </div>
            <div class="row pb-3">
                <div class="col-lg-6 col-md-6 mb-5">
                    ...
                    <ul>
                        <li>4-wheeler Nissan Cabstar closed van</li>
                        <li>4-wheeler Nissan Bida</li>
                        <li>4-wheeler Nissan Castro</li>
                        <li>6-wheeler Truck / ELF</li>
                        <li>10-wheeler Truck</li>
                        <li>Prime Movers for 20-45 ft. Container</li>
                    </ul>
                    {{-- <a class="border-bottom text-decoration-none" href="">Read More</a> --}}
                </div>
                <div class="col-lg-6 col-md-6 mb-5">
                    ...
                    <ul>
                        <li>Licensed Customs Broker and Representatives</li>
                        <li>Rapid customs clearance on all types of entries:</li>
                            <ul>
                                <li>Consumption Entry</li>
                                <li>imported goods for sale, barter or for hire whose value exceeds PHP 2,000 (Formal) or below Php 2,000 (Informal entry, including samples).</li>
                                <li>Warehousing Entry</li>
                                <li>import goods intended for use in manufacturing or Production, raw materials subject to processing into finished products and those for immediate exportation. </li>
                            </ul>
                        <li>Assistance for immediate facilitation of documentary requirements</li>
                        <li>Prompt and efficient cargo handling and delivery.</li>
                        <li>Competitive rates and quality of service rendition. </li>
                    </ul>
                    {{-- <a class="border-bottom text-decoration-none" href="">Read More</a> --}}
                </div>
            </div>
